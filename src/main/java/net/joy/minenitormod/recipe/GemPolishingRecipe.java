...
public class GemPolishingRecipe implements Recipe<SimpleContainer> {
    ...
    public GemPolishingRecipe(NonNullList<Ingredient> inputItems, ItemStack outputItem, ResourceLocation id) {
    ...
    public static class Serializer implements RecipeSerializer<GemPolishingRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(MinenitorMod.MOD_ID, "gem_polishing");
