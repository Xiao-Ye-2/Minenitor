...
public class ModBiomeModifier {
    ...
    public static final ResourceKey<BiomeModifier> ADD_PINE = registerKey("add_pine");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_PINE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(MinenitorMod.MOD_ID, name));
    }
}
